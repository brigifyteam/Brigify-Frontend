...
const MenteeSidebar = ({ currentStep = 1 }) => {
    const steps = [
        { number: 1, title: 'Skills & Interests', description: 'Select topics to personalize your feed.' },
        { number: 2, title: 'Career Goals', description: 'Set your professional objectives.' },
        { number: 3, title: 'Experience Level', description: 'Tell us about your background.' },
    ];
        ...
        <div className="w-80 h-screen fixed left-0 top-0 bg-white border-r border-gray-100 flex flex-col justify-between p-8 z-10 hidden lg:flex">
            ...
            <div className="flex items-center gap-3 pt-6 border-t border-gray-50">
                ...
                <div className="flex flex-col">
                    ...
                    <span className="text-xs text-slate-500">Setting up profile...</span>
                </div>
            </div>
        </div>
    );
